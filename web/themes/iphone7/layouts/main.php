        ...
        <nav class="navbar navbar-dark primary-color-dark">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-xs" id="collapseEx">
                    <!--Navbar Brand-->
                    <a class="navbar-brand" href="index.php"><?php echo Html::encode(\Yii::$app->name); ?></a>
                    <!--Links-->
                    <?php
      				        echo Menu::widget([
      				          'options' => [
    				            ...
    				            'items' => [
    				              ...
    				              ['label' => 'Find Us', 'url' => ['site/about'], "options" => [ "class" => "nav-item"]],
    				              ['label' => 'Contact', 'url' => ['site/contact'], "options" => [ "class" => "nav-item"]],
                          ['label' => 'Repairs', 'url' => ['site/repairs'], "options" => [ "class" => "nav-item"]],
                          ['label' => 'Recovery', 'url' => ['site/recovery'], "options" => [ "class" => "nav-item"]],
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="divider-new">
                              <img style='height: 100%; width: 100%; object-fit: contain' src="images/s&i%20new%20logo%20A2B.jpg">
                              <br>
                                <!--<h2 class="carousel slide carousel-fade z-depth-1-half"><?php echo Html::encode(\Yii::$app->name); ?></h2> -->
                            </div>
                            ...
                            <!--    <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="s&i%20new%20logo%20A2B.jpg" class="" alt="First slide">
                        ...
                        <div class="list-group">
                          <?php
                              ...
                              $selected = 'list-group-item active';
                                $unselected = 'list-group-item';
                          ?>
                            <?= Html::a('Commercial', ['site/commercial'], ['class' => 'list-group-item'])?></a>
                            <?= Html::a('Non-Commerical', ['site/noncommercial'], ['class' => 'list-group-item'])?></a>
                            <?= Html::a('24 Hour Recovery', ['site/recovery'], ['class' => 'list-group-item'])?></a>
                            <?= Html::a('Services', ['site/services'], ['class' => 'list-group-item'])?></a>
                            <?= Html::a('Repairs', ['site/repairs'], ['class' =>'list-group-item'])?></a>
                        </div>
                    </div>
<br>
                    <div>
                        ...
                        <h6>
                          <p>Unit 13<br>
                          Bridge Industrial Estate<br>
                          Hot lane<br>
                          Burslem<br>
                          Stoke-on-Trent<br>
                          ST6 2DL<br>
                          <a href="tel:01782 201932"> 01782 201932 </a><br>
                          </p>
                        </h6>
                          </div>
    ...
    <footer class="page-footer center-on-small-only primary-color-dark">
        ...
        <div class="footer-copyright">
            <div class="container-fluid">
              <?= Html::a('Copyright &copy; 2017 S And I Commercial ', ['site/termsandconditions'])?></a>
